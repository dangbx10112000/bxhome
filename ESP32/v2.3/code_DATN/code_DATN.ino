...
/* Functions is used to get status of pin*/
void get_statuspin(){
  String d12,d13,d14,d16,d18,d19,d23,d25,d26,d32,d33;
  if(digitalRead(12)==1){d12 = "ON";} else{d12 = "OFF";}
  if(digitalRead(13)==1){d13 = "ON";} else{d13 = "OFF";}
  if(digitalRead(14)==1){d14 = "ON";} else{d14 = "OFF";}
  if(digitalRead(16)==1){d16 = "ON";} else{d16 = "OFF";}
  if(digitalRead(18)==1){d18 = "ON";} else{d18 = "OFF";}
  if(digitalRead(19)==1){d19 = "ON";} else{d19 = "OFF";}
  if(digitalRead(23)==1){d23 = "ON";} else{d23 = "OFF";}
  if(digitalRead(25)==1){d25 = "ON";} else{d25 = "OFF";}
  if(digitalRead(26)==1){d26 = "ON";} else{d26 = "OFF";}
  if(digitalRead(32)==1){d32 = "ON";} else{d32 = "OFF";}
  if(digitalRead(33)==1){d33 = "ON";} else{d33 = "OFF";}
  String s = "{\"D12\": \""+ d12 +"\",\"D13\": \""+ d13 +"\",\"D14\": \""+ d14 +"\",\"D16\": \""+ d16 +"\",\"D18\": \""+ d18 +"\",\"D19\": \""+ d19 +"\",\"D23\": \""+ d23 +"\",\"D25\": \""+ d25 +"\",\"D26\": \""+ d26 +"\",\"D32\": \""+ d32 +"\",\"D33\": \""+ d33 +"\"}";
